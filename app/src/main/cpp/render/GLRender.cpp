...
int GLRender::Init(int initType) {
...
void GLRender::UpdateFrame(NativeImage *pImage) {
...
void
GLRender::SetTransformMatrix(float translateX, float translateY, float scaleX, float scaleY,
...
void GLRender::SetShaderIndex(int shaderIndex) {
...
int GLRender::GetShaderIndex() {
    LOGCATE("GLByteFlowRender::GetShaderIndex");
    return m_ShaderIndex;
}

bool GLRender::CreateTextures() {
...
void GLRender::UpdateMVPMatrix(glm::mat4 &mat4Matrix, TransformMatrix &transformMatrix) {
...
int
GLRender::CreateProgram(const char *pVertexShaderSource, const char *pFragShaderSource) {
...
float GLRender::GetFrameProgress() {
...
void GLRender::SetShaderProgramDynamicAttrib(int shaderIndex) {
...
void GLRender::LoadFilterImageData(int index, NativeImage *pImage) {
...
void GLRender::LoadFragShaderScript(int shaderIndex, char *pShaderStr, int strLen) {
