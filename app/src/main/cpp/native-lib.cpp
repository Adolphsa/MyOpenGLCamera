...
#include "render/ByteFlowDef.h"

#define CLASS_NAME_NATIVE_RENDER "com/lucas/opengl/render/NativeRender"
...
{
    RenderContext::CreateRenderContext(env, instance, renderType);
}

JNIEXPORT void JNICALL native_DestroyContext(JNIEnv *env, jobject instance)
{
    RenderContext::DeleteRenderContext(env, instance);
}

/*
 * Class:     com_lucas_opengl_render_NativeRender
 * Method:    native_Init
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL native_Init(JNIEnv *env, jobject instance, jint iniType)
{
    RenderContext *pContext = RenderContext::GetRenderContext(env, instance);
...
extern "C" jint JNI_OnLoad(JavaVM *jvm, void *p)
{
    ...
    jint regRet = RegisterNativeMethods(env, CLASS_NAME_NATIVE_RENDER, g_RenderMethods,
...
extern "C" void JNI_OnUnload(JavaVM *jvm, void *p)
{
    ...
    UnregisterNativeMethods(env, CLASS_NAME_NATIVE_RENDER);
}
